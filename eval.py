...
tf.app.flags.DEFINE_string('dataset_dir','/data/reid_data_large/validate/', 'directory of saving the training data')
...
def main(_):
    ...
    with tf.Graph().as_default() as graph:
        ...
        logits = model.create_model(images_a, images_b, reuse=False, is_training = False) 
