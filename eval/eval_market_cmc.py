...
tf.app.flags.DEFINE_string('model_feature_extract','MultiHeadAttentionBaseModel_set_share_feature_extract', 'the model name')
tf.app.flags.DEFINE_string('model_match','MultiHeadAttentionBaseModel_set_share_match', 'the model name')
